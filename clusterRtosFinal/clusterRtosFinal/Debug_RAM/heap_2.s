...
pvPortMalloc:
.LFB4:
	.file 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/portable/MemMang/heap_2.c"
	.loc 1 150 0
	.cfi_startproc
...
.LFE7:
	...
	.section	.bss.xHeapHasBeenInitialised.4655,"aw",%nobits
	.align	2
	.set	.LANCHOR1,. + 0
	.type	xHeapHasBeenInitialised.4655, %object
	.size	xHeapHasBeenInitialised.4655, 4
xHeapHasBeenInitialised.4655:
	.space	4
...
ucHeap:
	.space	8192
	.section	.data.xFreeBytesRemaining,"aw",%progbits
	.align	2
	.set	.LANCHOR4,. + 0
...
.Letext0:
	...
	.file 5 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/portable/GCC/ARM_CM4F/portmacro.h"
...
.Ldebug_info0:
	...
	.uleb128 0x5
	.byte	0x3
	.4byte	xHeapHasBeenInitialised.4655
	.uleb128 0xd
	.4byte	.LASF1116
	.byte	0x1
	.byte	0x99
...
.Ldebug_macro0:
	...
	.4byte	.LASF768
	.byte	0x4
	.file 23 "C:/Users/rbn/workspaceS32DS.ARM.2018.R1/clusterRtosFinal/clusterRtosFinal/Generated_Code/FreeRTOSConfig.h"
	.byte	0x3
	.uleb128 0x62
	.uleb128 0x17
	.byte	0x7
	...
	.uleb128 0x48
	.4byte	.LASF1037
	.file 28 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/include/list.h"
	.byte	0x3
	.uleb128 0x4e
	.uleb128 0x1c
	.byte	0x7
...
.LASF1087:
	.ascii	"heapMINIMUM_BLOCK_SIZE ( ( size_t ) ( heapSTRUCT_SI"
	.ascii	"ZE * 2 ) )\000"
.LASF1076:
...
.LASF1088:
	.ascii	"prvInsertBlockIntoFreeList(pxBlockToInsert) { Block"
	.ascii	"Link_t *pxIterator; size_t xBlockSize; xBlockSize ="
	.ascii	" pxBlockToInsert->xBlockSize; for( pxIterator = &xS"
	.ascii	"tart; pxIterator->pxNextFreeBlock->xBlockSize < xBl"
	.ascii	"ockSize; pxIterator = pxIterator->pxNextFreeBlock )"
	.ascii	" { } pxBlockToInsert->pxNextFreeBlock = pxIterator-"
	.ascii	">pxNextFreeBlock; pxIterator->pxNextFreeBlock = pxB"
	.ascii	"lockToInsert; }\000"
.LASF106:
...
.LASF1086:
	.ascii	"configADJUSTED_HEAP_SIZE ( configTOTAL_HEAP_SIZE - "
	.ascii	"portBYTE_ALIGNMENT )\000"
.LASF969:
...
.LASF1128:
	...
	.ascii	"0.8.6/rtos/FreeRTOS_S32K/Source/portable/MemMang/he"
	.ascii	"ap_2.c\000"
.LASF610:
