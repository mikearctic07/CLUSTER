...
void FLEXCAN0_transmit_msg(void) {
  ...
  ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 2] = 0xA5112233;
  ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 3] = 0x44556677;
  ...
  ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 1] = 0x14440000;
  ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 0] = 0x0C400000 | 4 <<16u;
...
void transmit(int id,int dlc, int word1, int word2){
   ((CAN_Type *)(0x40024000u))->IFLAG1 = 0x00000001;
   ...
   ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 1] = id;
   ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 0] = 0x0C400000 | 4 <<16u;
...
void FLEXCAN0_receive_msg(void) {
  ...
  for (j=0; j<2; j++) {
    RxDATA[j] = ((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 2 + j];
  }
