...
# 33 "C:/NXP/Workspace/CLUSTER/clusterRtosFinal/clusterRtosFinal/Sources/cluster.h" 2
...
void CLUSTER_Initialize(void)
{
  ...
  GPIO_Init_As_Output(3);
  GPIO_Init_As_Output(4);
  GPIO_Init_As_Output(5);

  GPIO_Init_As_Output(6);
  GPIO_Init_As_Output(7);
  GPIO_Init_As_Output(8);
  GPIO_Init_As_Output(9);
  GPIO_Init_As_Output(10);

  GPIO_Init_As_Output(23);
  GPIO_Init_As_Output(24);
  GPIO_Init_As_Output(25);
  GPIO_Init_As_Output(26);
  GPIO_Init_As_Output(27);
  GPIO_Init_As_Output(28);
  GPIO_Init_As_Output(29);
  ...
  if((GPIO_Read_Input(31)) && (GPIO_Read_Input(32)))
  {
   EEEPROM_Write_Data(300, 3);
   EEEPROM_Write_Data(100,1);
   EEEPROM_Write_Data(1,2);
  }
}
...
void CLUSTER_Display_Gas_Tank_Level(int *ptrTankLevelValue, int *ptrCount)
{
 if(*ptrCount == 0)
 {
  ...
  else
  {
   ...
   else
   {
    ...
    {
     GPIO_Set_On_Output(9);
     if(*ptrTankLevelValue < 555)
     {
      GPIO_Set_Off_Output(10);
     }
     else
     {
      GPIO_Set_On_Output(10);
     }
    }
   }
  }
 ...
 else
 {
  ...
  else if(*ptrTankLevelValue < (555>>1))
  {
   *ptrCount = *ptrCount + 1;
   if(*ptrCount == 40)
   {
  ...
  else if(*ptrTankLevelValue < ((555*3)>>2))
  {
   *ptrCount = *ptrCount + 1;
   if(*ptrCount == 20)
   {
...
void CLUSTER_Display_Velocimeter_Value(int *ptrSpeedValue)
{
 ...
 switch(unitsValue)
 {
  case 0:
  {
   GPIO_Set_Off_Output(15);
   GPIO_Set_Off_Output(16);
   GPIO_Set_Off_Output(17);
   GPIO_Set_Off_Output(18);
  }break;
  case 1:
  {
   GPIO_Set_On_Output(15);
   GPIO_Set_Off_Output(16);
   GPIO_Set_Off_Output(17);
   GPIO_Set_Off_Output(18);
  }break;
...
void CLUSTER_Display_Odometer_Value(int distanceValue)
{
 ...
 for(i = 0; i < 7; i++)
 {
  LCD_Data_Write((char)(48+distanceValue/div));
...
void CLUSTER_Display_Trip_Odometer_Value(int tripDistanceValue)
{
 ...
 for(i = 0; i < 7; i++)
 {
  LCD_Data_Write((char)(48+tripDistanceValue/div));
