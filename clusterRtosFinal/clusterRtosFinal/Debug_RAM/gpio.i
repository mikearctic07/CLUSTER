...
void GPIO_Init_As_Input(int input)
{
  ...
  {
    case 'A':
      ((GPIO_Type *)(0x400FF000u))->PDDR &= ~(1<<pinNumber);
      ((PORT_Type *)(0x40049000u))->PCR[pinNumber] = pinAsGpioInterrputEnable;
      break;
    case 'B':
      ((GPIO_Type *)(0x400FF040u))->PDDR &= ~(1<<pinNumber);
      ((PORT_Type *)(0x4004A000u))->PCR[pinNumber] = pinAsGpioInterrputEnable;
      break;
    case 'C':
      ((GPIO_Type *)(0x400FF080u))->PDDR &= ~(1<<pinNumber);
      ((PORT_Type *)(0x4004B000u))->PCR[pinNumber] = pinAsGpioInterrputEnable;
      break;
    case 'D':
      ((GPIO_Type *)(0x400FF0C0u))->PDDR &= ~(1<<pinNumber);
      ((PORT_Type *)(0x4004C000u))->PCR[pinNumber] = pinAsGpioInterrputEnable;
      break;
    case 'E':
      ((GPIO_Type *)(0x400FF100u))->PDDR &= ~(1<<pinNumber);
      ((PORT_Type *)(0x4004D000u))->PCR[pinNumber] = pinAsGpioInterrputEnable;
      break;
    default:
      break;
  }
...
int GPIO_Read_Input(int input)
{
  ...
  {
    case 'A':
      output = (((GPIO_Type *)(0x400FF000u))->PDIR & (1<<pinNumber))>>pinNumber;
      break;
    case 'B':
      output = (((GPIO_Type *)(0x400FF040u))->PDIR & (1<<pinNumber))>>pinNumber;
      break;
    case 'C':
      output = (((GPIO_Type *)(0x400FF080u))->PDIR & (1<<pinNumber))>>pinNumber;
      break;
    case 'D':
      output = (((GPIO_Type *)(0x400FF0C0u))->PDIR & (1<<pinNumber))>>pinNumber;
      break;
    case 'E':
      output = (((GPIO_Type *)(0x400FF100u))->PDIR & (1<<pinNumber))>>pinNumber;
      break;
    default:
      break;
  }
...
int GPIO_Read_Input_Interrupt(int input)
{
  ...
  {
    case 'A':
      output = (((PORT_Type *)(0x40049000u))->ISFR & (1<<pinNumber))>>pinNumber;
      break;
    case 'B':
      output = (((PORT_Type *)(0x4004A000u))->ISFR & (1<<pinNumber))>>pinNumber;
      break;
    case 'C':
      output = (((PORT_Type *)(0x4004B000u))->ISFR & (1<<pinNumber))>>pinNumber;
      break;
    case 'D':
      output = (((PORT_Type *)(0x4004C000u))->ISFR & (1<<pinNumber))>>pinNumber;
      break;
    case 'E':
      output = (((PORT_Type *)(0x4004D000u))->ISFR & (1<<pinNumber))>>pinNumber;
      break;
    default:
      break;
  }
...
void GPIO_Init_As_Output(int output)
{
  ...
  switch (port)
  {
    case 'A':
      ((GPIO_Type *)(0x400FF000u))->PDDR |= 1<<pinNumber;
      ((PORT_Type *)(0x40049000u))->PCR[pinNumber] = pinAsGpio;
      break;
    case 'B':
      ((GPIO_Type *)(0x400FF040u))->PDDR |= 1<<pinNumber;
      ((PORT_Type *)(0x4004A000u))->PCR[pinNumber] = pinAsGpio;
      break;
    case 'C':
      ((GPIO_Type *)(0x400FF080u))->PDDR |= 1<<pinNumber;
      ((PORT_Type *)(0x4004B000u))->PCR[pinNumber] = pinAsGpio;
      break;
    case 'D':
      ((GPIO_Type *)(0x400FF0C0u))->PDDR |= 1<<pinNumber;
      ((PORT_Type *)(0x4004C000u))->PCR[pinNumber] = pinAsGpio;
      break;
    case 'E':
      ((GPIO_Type *)(0x400FF100u))->PDDR |= 1<<pinNumber;
      ((PORT_Type *)(0x4004D000u))->PCR[pinNumber] = pinAsGpio;
      break;
    default:
      break;
  }
...
void GPIO_Set_Off_Output(int output)
{
  ...
  {
 case 'A':
   ((GPIO_Type *)(0x400FF000u))->PCOR |= 1<<pinNumber;
   break;
 case 'B':
   ((GPIO_Type *)(0x400FF040u))->PCOR |= 1<<pinNumber;
   break;
 case 'C':
   ((GPIO_Type *)(0x400FF080u))->PCOR |= 1<<pinNumber;
   break;
 case 'D':
   ((GPIO_Type *)(0x400FF0C0u))->PCOR |= 1<<pinNumber;
   break;
 case 'E':
   ((GPIO_Type *)(0x400FF100u))->PCOR |= 1<<pinNumber;
   break;
 default:
   break;
  }
...
void GPIO_Set_On_Output(int output)
{
  ...
  {
 case 'A':
   ((GPIO_Type *)(0x400FF000u))->PSOR |= 1<<pinNumber;
   break;
 case 'B':
   ((GPIO_Type *)(0x400FF040u))->PSOR |= 1<<pinNumber;
   break;
 case 'C':
   ((GPIO_Type *)(0x400FF080u))->PSOR |= 1<<pinNumber;
   break;
 case 'D':
   ((GPIO_Type *)(0x400FF0C0u))->PSOR |= 1<<pinNumber;
   break;
 case 'E':
   ((GPIO_Type *)(0x400FF100u))->PSOR |= 1<<pinNumber;
   break;
 default:
   break;
  }
...
void GPIO_Set_On_Ouput_Mask(int output, int mask)
{
  ...
  {
 case 'A':
   ((GPIO_Type *)(0x400FF000u))->PDOR = (((GPIO_Type *)(0x400FF000u))->PDOR&(~(0xF<<pinNumber)))|(mask<<pinNumber);
   break;
 case 'B':
   ((GPIO_Type *)(0x400FF040u))->PDOR = (((GPIO_Type *)(0x400FF040u))->PDOR&(~(0xF<<pinNumber)))|(mask<<pinNumber);
   break;
 case 'C':
   ((GPIO_Type *)(0x400FF080u))->PDOR = (((GPIO_Type *)(0x400FF080u))->PDOR&(~(0xF<<pinNumber)))|(mask<<pinNumber);
   break;
 case 'D':
   ((GPIO_Type *)(0x400FF0C0u))->PDOR = (((GPIO_Type *)(0x400FF0C0u))->PDOR&(~(0xF<<pinNumber)))|(mask<<pinNumber);
   break;
 case 'E':
   ((GPIO_Type *)(0x400FF100u))->PDOR = (((GPIO_Type *)(0x400FF100u))->PDOR&(~(0xF<<pinNumber)))|(mask<<pinNumber);
   break;
 default:
   break;
  }
...
void GPIO_Toggle(int output)
{
  ...
  {
 case 'A':
   ((GPIO_Type *)(0x400FF000u))->PTOR |= 1<<pinNumber;
   break;
 case 'B':
   ((GPIO_Type *)(0x400FF040u))->PTOR |= 1<<pinNumber;
   break;
 case 'C':
   ((GPIO_Type *)(0x400FF080u))->PTOR |= 1<<pinNumber;
   break;
 case 'D':
   ((GPIO_Type *)(0x400FF0C0u))->PTOR |= 1<<pinNumber;
   break;
 case 'E':
   ((GPIO_Type *)(0x400FF100u))->PTOR |= 1<<pinNumber;
   break;
 default:
   break;
  }
...
void GPIO_Clear_Interrupt(int input)
{
 ...
 case 'A':
   ...
   regValue = ((PORT_Type *)(0x40049000u))->PCR[pinNumber];
   regValue &= ~(0x1000000u);
   regValue |= (((uint32_t)(((uint32_t)(1))<<24u))&0x1000000u);
   ((PORT_Type *)(0x40049000u))->PCR[pinNumber] = regValue;
   break;
 case 'B':

   regValue = ((PORT_Type *)(0x4004A000u))->PCR[pinNumber];
   regValue &= ~(0x1000000u);
   regValue |= (((uint32_t)(((uint32_t)(1))<<24u))&0x1000000u);
   ((PORT_Type *)(0x4004A000u))->PCR[pinNumber] = regValue;
   break;
 case 'C':

   regValue = ((PORT_Type *)(0x4004B000u))->PCR[pinNumber];
   regValue &= ~(0x1000000u);
   regValue |= (((uint32_t)(((uint32_t)(1))<<24u))&0x1000000u);
   ((PORT_Type *)(0x4004B000u))->PCR[pinNumber] = regValue;
   break;
 case 'D':

   regValue = ((PORT_Type *)(0x4004C000u))->PCR[pinNumber];
   regValue &= ~(0x1000000u);
   regValue |= (((uint32_t)(((uint32_t)(1))<<24u))&0x1000000u);
   ((PORT_Type *)(0x4004C000u))->PCR[pinNumber] = regValue;
   break;
 case 'E':

   regValue = ((PORT_Type *)(0x4004D000u))->PCR[pinNumber];
   regValue &= ~(0x1000000u);
   regValue |= (((uint32_t)(((uint32_t)(1))<<24u))&0x1000000u);
   ((PORT_Type *)(0x4004D000u))->PCR[pinNumber] = regValue;
   break;
 default:
   break;
  }
  ...
  void GPIO_Enable_Port_Interrupt(char_t port)
  {
   ...
   {
     case 'A':
      ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(PORTA_IRQn) >> 5U] = (uint32_t)(1UL << ((uint32_t)(PORTA_IRQn) & (uint32_t)0x1FU));
       break;
     case 'B':
      ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(PORTB_IRQn) >> 5U] = (uint32_t)(1UL << ((uint32_t)(PORTB_IRQn) & (uint32_t)0x1FU));
       break;
     case 'C':
      ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(PORTC_IRQn) >> 5U] = (uint32_t)(1UL << ((uint32_t)(PORTC_IRQn) & (uint32_t)0x1FU));
       break;
     case 'D':
      ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(PORTD_IRQn) >> 5U] = (uint32_t)(1UL << ((uint32_t)(PORTD_IRQn) & (uint32_t)0x1FU));
       break;
     case 'E':
      ((S32_NVIC_Type *)(0xE000E100u))->ISER[(uint32_t)(PORTE_IRQn) >> 5U] = (uint32_t)(1UL << ((uint32_t)(PORTE_IRQn) & (uint32_t)0x1FU));
       break;
     default:
       break;
   }
...
void GPIO_Clear_Port_Outputs(char port)
{
  ...
  {
 case 'A':
   ((GPIO_Type *)(0x400FF000u))->PDOR = ((GPIO_Type *)(0x400FF000u))->PDOR&(0x0);
   break;
 case 'B':
   ((GPIO_Type *)(0x400FF040u))->PDOR = ((GPIO_Type *)(0x400FF040u))->PDOR&(0x0);
   break;
 case 'C':
   ((GPIO_Type *)(0x400FF080u))->PDOR = ((GPIO_Type *)(0x400FF080u))->PDOR&(0x0);
   break;
 case 'D':
   ((GPIO_Type *)(0x400FF0C0u))->PDOR = ((GPIO_Type *)(0x400FF0C0u))->PDOR&(0x0);
   break;
 case 'E':
   ((GPIO_Type *)(0x400FF100u))->PDOR = ((GPIO_Type *)(0x400FF100u))->PDOR&(0x0);
   break;
 default:
   break;
  }
