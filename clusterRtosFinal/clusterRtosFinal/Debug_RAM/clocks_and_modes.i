...
# 11 "../Sources/clocks_and_modes.c" 2
...
# 12 "../Sources/clocks_and_modes.c" 2

void WDOG_disable (void){
  ((WDOG_Type *)(0x40052000u))->CNT=0xD928C520;
  ((WDOG_Type *)(0x40052000u))->TOVAL=0x0000FFFF;
  ((WDOG_Type *)(0x40052000u))->CS = 0x00002100;
}

void SOSC_init_8MHz(void) {
  ((SCG_Type *)(0x40064000u))->SOSCDIV=0x00000101;
  ((SCG_Type *)(0x40064000u))->SOSCCFG=0x00000024;
...
void SPLL_init_160MHz(void) {
  while(((SCG_Type *)(0x40064000u))->SPLLCSR & 0x800000u);
  ((SCG_Type *)(0x40064000u))->SPLLCSR = 0x00000000;
  ((SCG_Type *)(0x40064000u))->SPLLDIV = 0x00000302;
  ((SCG_Type *)(0x40064000u))->SPLLCFG = 0x00180000;


  while(((SCG_Type *)(0x40064000u))->SPLLCSR & 0x800000u);
  ((SCG_Type *)(0x40064000u))->SPLLCSR = 0x00000001;




  while(!(((SCG_Type *)(0x40064000u))->SPLLCSR & 0x1000000u));
}

void NormalRUNmode_80MHz (void) {
  ((SCG_Type *)(0x40064000u))->RCCR=(((uint32_t)(((uint32_t)(6))<<24u))&0xF000000u)
    |(((uint32_t)(((uint32_t)(0b01))<<16u))&0xF0000u)
    |(((uint32_t)(((uint32_t)(0b01))<<4u))&0xF0u)
    |(((uint32_t)(((uint32_t)(0b10))<<0u))&0xFu);
  while (((((SCG_Type *)(0x40064000u))->CSR & 0xF000000u) >> 24u ) != 6) {}
