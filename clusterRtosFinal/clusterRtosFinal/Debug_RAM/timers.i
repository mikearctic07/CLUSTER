# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
...
# 1 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
# 71 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
...
# 72 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c" 2
...
#define xList List_t
# 79 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c" 2
...
# 80 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c" 2
...
# 81 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c" 2
...
# 82 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c" 2
# 91 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
#undef MPU_WRAPPERS_INCLUDED_FROM_API_FILE
# 101 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
...
# 185 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
...
BaseType_t xReturn = ( ( ( BaseType_t ) 0 ) );
 ...
 if( xTimerQueue != ((void *)0) )
 {
...

  {
   ...
   xReturn = xTaskGenericCreate( ( prvTimerTask ), ( "Tmr Svc" ), ( ( uint16_t ) 180 ), ( ((void *)0) ), ( ( ( UBaseType_t ) ( 2 ) ) | ( ( UBaseType_t ) 0x00 ) ), ( ((void *)0) ), ( ((void *)0) ), ( ((void *)0) ) );
  }
...
# 370 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
const char * pcTimerGetTimerName( TimerHandle_t xTimer )
{
...
Timer_t * const pxTimer = ( Timer_t * ) ( (&( ( pxCurrentTimerList )->xListEnd ))->pxNext->pvOwner );
 ...
 if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
 {
  ...
  if( prvInsertTimerInActiveList( pxTimer, ( xNextExpireTime + pxTimer->xTimerPeriodInTicks ), xTimeNow, xNextExpireTime ) == ( ( BaseType_t ) 1 ) )
  {
   ...
   xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xNextExpireTime, ((void *)0), ( TickType_t ) 0U );
...
{
TickType_t xNextExpireTime;
# 506 "C:/NXP/S32DS_ARM_v2018.R1/S32DS/S32SDK_S32K14x_EAR_0.8.6/rtos/FreeRTOS_S32K/Source/timers.c"
...
TickType_t xTimeNow;
 ...
 while( xQueueGenericReceive( ( xTimerQueue ), ( &xMessage ), ( ( TickType_t ) 0U ), ( ( BaseType_t ) 0 ) ) != ( ( ( BaseType_t ) 0 ) ) )
 {
  ...
  if( xMessage.xMessageID >= ( BaseType_t ) 0 )
  {
   ...
   if( ( ( BaseType_t ) ( ( &( pxTimer->xTimerListItem ) )->pvContainer == ( void * ) ( ((void *)0) ) ) ) == ( ( BaseType_t ) 0 ) )
   {
   ...
   switch( xMessage.xMessageID )
   {
    ...
    case ( ( BaseType_t ) 0 ) :
     ...
     if( prvInsertTimerInActiveList( pxTimer, xMessage.u.xTimerParameters.xMessageValue + pxTimer->xTimerPeriodInTicks, xTimeNow, xMessage.u.xTimerParameters.xMessageValue ) == ( ( BaseType_t ) 1 ) )
     {
      ...
      if( pxTimer->uxAutoReload == ( UBaseType_t ) ( ( BaseType_t ) 1 ) )
      {
       xResult = xTimerGenericCommand( pxTimer, ( ( BaseType_t ) 0 ), xMessage.u.xTimerParameters.xMessageValue + pxTimer->xTimerPeriodInTicks, ((void *)0), ( TickType_t ) 0U );
       if((xResult)==0) { vPortRaiseBASEPRI(); for( ;; ); };
       ( void ) xResult;
      }
      else
...
Timer_t *pxTimer = ( Timer_t * ) xTimer;
 ...
 vPortEnterCritical();
 {
  ...
  xTimerIsInActiveList = ( BaseType_t ) !( ( ( BaseType_t ) ( ( &( pxTimer->xTimerListItem ) )->pvContainer == ( void * ) ( ((void *)0) ) ) ) );
 }
 vPortExitCritical();
