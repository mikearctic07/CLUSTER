...
#define Cpu_H 
# 62 "C:/NXP/Workspace/CLUSTER/clusterRtosFinal/clusterRtosFinal/Generated_Code/Cpu.h"
...
#define MB_ID_RECEIVE 0x14440000
#define MB_ID_STATUS 0x95C0000
#define ID_SEND 0x555
#define MB_RECEPTION_EN 0x04000000
#define NO_FLXCAN 0x0000001F
#define BYTE0 24
#define BYTE1 16
#define BYTE2 8
#define BYTE 0XFF
...
void CLUSTER_Display_Odometer_Value(int distanceValue);

void CLUSTER_Display_Trip_Odometer_Value(int tripDistanceValue);
# 14 "../Sources/rtos.c" 2
...
void rtos_start( void )
{
 ...
 if( xQueue != ((void *)0) )
 {
  ...
  xTaskGenericCreate( ( canTask ), ( "CAN" ), ( ( ( unsigned short ) 90 ) ), ( ((void *)0) ), ( ( ( ( UBaseType_t ) 0U ) + 2 ) ), ( ((void *)0) ), ( ((void *)0) ), ( ((void *)0) ) );
...
static void tnkTask( void *pvParameters )
{
 ...
 for( ;; )
 {
  ...
  int tnkFlag = EEEPROM_Read_Data(3);
