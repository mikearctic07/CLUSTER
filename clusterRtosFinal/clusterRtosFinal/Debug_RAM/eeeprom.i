...
int EEEPROM_Init()
{
 if ((((FTFC_Type *)(0x40020000u))->FCNFG & 0x1u) == 0U)
 {
  volatile int timeout;
  ((FTFC_Type *)(0x40020000u))->FCCOB[3]=0x80;
  ((FTFC_Type *)(0x40020000u))->FCCOB[2]=0x00;
  ((FTFC_Type *)(0x40020000u))->FCCOB[1]=0x00;
  ((FTFC_Type *)(0x40020000u))->FCCOB[0]=0x00;
  ((FTFC_Type *)(0x40020000u))->FCCOB[7]=0x02;
  ((FTFC_Type *)(0x40020000u))->FCCOB[6]=0x08;
...
int EEEPROM_Write_Data(int data, int target)
{
 while ((((FTFC_Type *)(0x40020000u))->FSTAT & 0x80u) == 0){}
 switch(target)
 {
  case 1:
  {
