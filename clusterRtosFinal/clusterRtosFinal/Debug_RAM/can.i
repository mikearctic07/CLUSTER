...
#define MSG_BUF_SIZE 4
 ...
 ((CAN_Type *)(0x40024000u))->MCR |= 0x80000000u;
 ((CAN_Type *)(0x40024000u))->CTRL1 &= ~0x2000u;
 ((CAN_Type *)(0x40024000u))->MCR &= ~0x80000000u;
...
# 28 "../Sources/can.c"
 ...
 for(i=0; i<16; i++ ) {
  ((CAN_Type *)(0x40024000u))->RXIMR[i] = 0xFFFFFFFF;
 }
...
# 46 "../Sources/can.c"
 ...
 ((CAN_Type *)(0x40024000u))->MCR = 0x0000001F;
 while ((((CAN_Type *)(0x40024000u))->MCR && 0x1000000u) >> 24u) {}

 while ((((CAN_Type *)(0x40024000u))->MCR && 0x8000000u) >> 27u) {}

}

void CAN_transmit(int id,int dlc, int word1, int word2){
 ((CAN_Type *)(0x40024000u))->IFLAG1 = 0x00000001;
 ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 2] = word1;
 ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 3] = word2;
 ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 1] = CAN_id2Val(id);
 ((CAN_Type *)(0x40024000u))->RAMn[ 0*4 + 0] = 0x0C400000 | dlc <<16u;
...
void CAN_receive(uint8_t * speed, uint8_t * tnk, uint16_t * od, uint16_t * trOd, uint8_t * ind){
 ...
 if(((CAN_Type *)(0x40024000u))->IFLAG1 & 1 << 4){
  RxCODE = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 0] & 0x07000000) >> 24;
  RxID = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 1] & 0x1FFFFFFFu) >> 0u ;
  RxLENGTH = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 0] & 0xF0000u) >> 16u;


  info.idCommand = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 2 + 0] & (0XFF << 24)) >> 24;
  info.numParams = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 2 + 0] & (0XFF << 16)) >> 16;
  info.param0 = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 2 + 0] & (0XFF << 8)) >> 8;
  info.param1 = (((CAN_Type *)(0x40024000u))->RAMn[ 4*4 + 2 + 0] & 0XFF);
 ...
 if(((CAN_Type *)(0x40024000u))->IFLAG1 & 1<<3){
  ((CAN_Type *)(0x40024000u))->IFLAG1 = 0x00000008;
  CAN_transmit(0x555,8,0xFFFFFFFF,0xFFFFFFFF);
 }
